...
<tr>
	<?php the_project_table_header( array('show_dataset_image' => true) ); ?>
</tr>

<?php while ( have_datasets() ) : the_dataset(); ?>
	<tr class="<?php the_dataset_class(); ?>" valign="top">
		<?php the_dataset_metadata( array('output' => 'td', 'show_dataset_image' => true, 'imagesize' => 'tiny') ); ?>
	</tr>
<?php endwhile; ?>
